    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8 lg:py-28">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/register"
                className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-bold text-white shadow-sm transition hover:bg-blue-700"
              >
                Start Preparing →
              </Link>
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-6 py-3.5 text-sm font-bold text-slate-700 transition hover:bg-slate-50"
              >
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -right-10 h-40 w-40 rounded-full bg-indigo-100 blur-3xl" />
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {plans.map((plan) => (
              ...
              >
                ...
                <Link
                  href="/register"
                  className="mt-6 rounded-lg border border-slate-300 px-4 py-2.5 text-center text-sm font-semibold text-slate-700 transition hover:bg-slate-50"
                >
                  Get Started
                </Link>
              </div>
      ...
      <section className="bg-blue-600 py-20">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/login"
              className="rounded-xl border border-blue-300 px-6 py-3.5 text-sm font-bold text-white transition hover:bg-blue-700"
            >
              Login
            </Link>
          </div>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-8 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8">
          <div>
            <p className="font-bold text-slate-900">Student Prep</p>
